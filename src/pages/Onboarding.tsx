...
const SEASONED_PIPELINE: PipelineStepDef[] = [
  ...
  { id: "pillars", label: "Creating your content pillars…", status: "waiting" },
  { id: "weekposts", label: "Writing your first week of posts…", status: "waiting" },
  { id: "plans", label: "Building branding, funnel & content plans…", status: "waiting" },
  { id: "templates", label: "Creating content templates…", status: "waiting" },
];
