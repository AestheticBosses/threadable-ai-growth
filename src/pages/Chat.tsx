...
const QUICK_ACTIONS = [
  ...
  { icon: "📈", label: "What's trending", action: "trending" as const, message: "Based on my niche, audience, and top-performing content patterns, suggest 5 timely topics I should post about this week.\n\nFor each topic:\n1. Give a bold topic title\n2. Explain WHY this is trending or timely for my audience right now\n3. Write a complete, ready-to-publish post on this topic using my real stories, data, and voice\n4. Use the emotional triggers and hook patterns from my top-performing posts\n\nStudy my top posts and regression insights to inform the hooks and structures. Use my real data — no brackets or placeholders.\n\nFormat: **1. Topic Title** then the explanation and full post text." },
