...
const QUICK_ACTIONS = [
  ...
  { icon: "📈", label: "What's trending", action: "trending" as const, message: "Study the COMPETITOR INSIGHTS section of my context — look at the top-performing competitor posts and the accounts I'm studying. Also look at my niche and what topics resonate with my dream client.\n\nBased on what's working for competitors in my niche AND what performs well for me, suggest 5 timely topics I should post about this week.\n\nFor each topic:\n1. Give a bold topic title\n2. Explain WHY this is trending — reference a specific competitor post pattern or niche trend that proves it\n3. Write a complete, ready-to-publish post on this topic using MY real stories, data, and voice (not the competitor's content)\n4. Use the emotional triggers and hook patterns from my top-performing posts\n\nThe goal: spot what's working in my niche right now and create my own version using my identity and voice.\n\nFormat each as: **1. Topic Title** then the explanation, then the full post text. Use my real data — no brackets or placeholders." },
