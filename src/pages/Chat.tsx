...
const QUICK_ACTIONS = [
  ...
  { icon: "📈", label: "What's trending", action: "trending" as const, message: "Based on what's trending in my niche right now, give me 3 post ideas that match my archetypes and use my real stories.\n\nUse everything you know about my niche, my dream client, and what topics resonate with my audience. If you have competitor insights in my context, use their top-performing post patterns as inspiration — but if not, use your knowledge of what's currently working in my niche.\n\nFor each idea, write the FULL ready-to-publish post text using my real stories, numbers, and voice.\n\nFormat EXACTLY like this (post text comes first, metadata lines at the very end):\n\n**1. Topic Title**\n[the full post text here — multiple paragraphs, ready to publish]\nArchetype: Name\nFunnel Stage: TOF\n\n**2. Topic Title**\n[the full post text here]\nArchetype: Name\nFunnel Stage: MOF\n\nIMPORTANT: The Archetype and Funnel Stage lines must be the LAST two lines of each idea, each on their own line. Do NOT combine them on one line. Do NOT add any other metadata lines. The post text goes between the title and the metadata.\n\nUse my real data — no brackets or placeholders." },
